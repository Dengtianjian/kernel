 ...
 * 生成模型命令
 *
 * 命令名 make:model 在 kernel/Routes/index.php 中注册（Router::command）。
 *
 * 用法：
...
PHP;
    ...
    return $this->write(FileSystem::root() . "/Model", $classPath, $namespace, $body, !empty($options["force"]), $console) ? 0 : 1;
  }
}
