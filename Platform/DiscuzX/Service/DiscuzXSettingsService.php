...
use kernel\Service\SettingsService;

class DiscuzXSettingsService extends SettingsService
{
  ...
  {
    self::$settingsModel = new DiscuzXSettingsModel(self::$SettingsTableName);
  }
}
